...
//     return (
//         <div
//             className={`${randomColor()} rounded-xl p-6 group text-center m-3 cursor-pointer shadow-lg transition-all duration-300 ease-in-out transform ${isHovered ? 'scale-105 rotate-1' : ''} hover:shadow-xl`}
